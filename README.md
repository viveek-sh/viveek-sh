...
<div align="center">
  <img src="https://skillicons.dev/icons?i=ts,js,html,css,tailwind,react,nextjs,nodejs,express,mongodb,postgres,prisma,redis,docker,aws,cloudflare,nginx,linux,git,github,wordpress,python,java,cpp,ps,vscode,vite,postman,npm&size=24" />
